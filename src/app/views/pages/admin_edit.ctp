...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Apagar', true), array('action'=>'delete', $form->value('Page.id')), null, sprintf(__('Deseja mesmo apagar esta página?', true), $form->value('Page.id'))); ?></li>
		<li><?php echo $html->link(__('Lista Páginas', true), array('action'=>'index'));?></li>
	</ul>
</div>
<?php 
