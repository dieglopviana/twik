...
<?php echo $form->create('Auction');?>
	<fieldset>
 		<legend><?php __('Editar Leilão');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Apagar', true), array('action'=>'delete', $form->value('Auction.id')), null, sprintf(__('Deseja mesmo apagar este leilão?', true), $form->value('Auction.id'))); ?></li>
